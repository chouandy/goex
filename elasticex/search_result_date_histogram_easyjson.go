...
func easyjson87940f94DecodeGithubComChouandyGoexElasticex2(in *jlexer.Lexer, out *SearchDateHistogramBuckets) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "buckets":
			if in.IsNull() {
				...
				if out.Buckets == nil {
					if !in.IsDelim(']') {
						out.Buckets = make([]SearchDateHistogramItem, 0, 2)
					} else {
						out.Buckets = []SearchDateHistogramItem{}
					}
				} else {
					out.Buckets = (out.Buckets)[:0]
				}
				for !in.IsDelim(']') {
					var v1 SearchDateHistogramItem
...
func easyjson87940f94EncodeGithubComChouandyGoexElasticex2(out *jwriter.Writer, in SearchDateHistogramBuckets) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalJSON supports json.Marshaler interface
func (v SearchDateHistogramBuckets) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson87940f94EncodeGithubComChouandyGoexElasticex2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}

// MarshalEasyJSON supports easyjson.Marshaler interface
func (v SearchDateHistogramBuckets) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson87940f94EncodeGithubComChouandyGoexElasticex2(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *SearchDateHistogramBuckets) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson87940f94DecodeGithubComChouandyGoexElasticex2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *SearchDateHistogramBuckets) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson87940f94DecodeGithubComChouandyGoexElasticex2(l, v)
}
